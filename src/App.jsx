...
import {
  ...
  createStaffAccount, sendPasswordReset, changeOwnPassword,
} from "./storage.js";
  ...
  return (
    <div className="min-h-screen bg-[#F5F6F8] font-[Inter] text-slate-800">
      ...
      >
        ...
        {/* Sparkle decorations */}
        <Sparkles size={22} className="absolute top-24 left-8 text-[#F97316] opacity-70 hidden sm:block" />
        <Sparkles size={16} className="absolute top-16 right-24 text-[#22D3EE] opacity-70 hidden sm:block" />
        <Sparkles size={14} className="absolute bottom-20 left-1/4 text-white opacity-40 hidden md:block" />
        ...
        <div className="max-w-5xl mx-auto relative z-10 mt-10">
          ...
          <div className="flex flex-wrap items-center gap-3 mt-8">
            ...
            <a
              href="https://t.me/BossElectronicsET"
              target="_blank"
              rel="noreferrer"
